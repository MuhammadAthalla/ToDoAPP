      ...
      <tbody>
        <?php while ($row = mysqli_fetch_array($alldata)) { ?>
          ...
          <tr>
            ...
            <td style="width:5%"><a href="edit.php?ID=<?php echo $row['Id'] ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen"></i></a></td>
            <td style="width:5%"><a href="delete.php?ID=<?php echo $row['Id'] ?>" class="btn btn-outline-danger"><i class="fa-sharp fa-solid fa-check"></i></i></a></td>
          </tr>
